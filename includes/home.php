...
foreach ($cursor as $document) {
   ...
   ?><p><?php echo nl2br( "Likes: " . $document["likes"]); ?>
   <input type="image" id="likebutton" name="likebutton" style="display:inline" value="<?php echo $title ?>" src="includes/images/likebutton.png" onclick="like(this.value)" /><?php
