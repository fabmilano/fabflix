...
foreach ($cursor as $document) {
   ...
   ?><p><input type="image" id="likebutton" name="likebutton" value="<?php echo $title ?>" src="/images/likebutton.png" onclick="like(this.value)"></p><hr><?php
