...
foreach ($cursor as $document) {
   ...
   ?><input type="image" id="likebutton" name="likebutton" style="position: absolute; left:400px" value="<?php echo $title ?>" src="includes/images/likebutton.png" onclick="like(this.value)" /><?php
